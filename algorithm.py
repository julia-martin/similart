...
def art_neighbors(imageArray):
    ...
    test_data = pca_model.transform(imageArray)
...
def create_nodes(argdistances, source = 3000): 
    ...
    # source refers to the index of the source image. 3000 refers to uploaded image

    
    #converts the argdist to the actual image id
...
def create_edges(distances,argdistances,source = 3000):
...
def construct_network(image):
    ...
    for arg in argdist:
        ...
        nodes.append(create_nodes(argdist, source = arg))
